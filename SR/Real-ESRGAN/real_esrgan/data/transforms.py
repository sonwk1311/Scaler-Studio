...
def center_crop_torch(
        gt_images: Union[np.ndarray, Tensor, list[np.ndarray], list[Tensor]],
        lr_images: Union[np.ndarray, Tensor, list[np.ndarray], list[Tensor]],
        gt_patch_size: int,
        upscale_factor: int,
) -> tuple[
        Union[np.ndarray, Tensor, list[np.ndarray], list[Tensor]],
        Union[np.ndarray, Tensor, list[np.ndarray], list[Tensor]]]: 
